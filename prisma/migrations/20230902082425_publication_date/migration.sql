/*
  ...
  - You are about to drop the column `publicatioDate` on the `books` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "books" DROP COLUMN "publicatioDate",
